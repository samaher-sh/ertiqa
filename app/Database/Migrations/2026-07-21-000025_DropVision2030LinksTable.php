...
class DropVision2030LinksTable extends Migration
{
    public function up()
    {
        $this->forge->dropTable('vision2030_links', true); // true = IF EXISTS، آمن حتى لو الجدول مو موجود لأي سبب
    }

    public function down()
    {
        // إعادة إنشاء الجدول لو احتجنا نرجع الميزة يومًا (Rollback support)
        $this->forge->addField([

...
<body>
    ...
    <p class="body-p">نود الإفادة بأن إدارة المراجعة الداخلية بصدد القيام بزيارة <mark><?= esc($targetDept['name_ar'] ?? '') ?></mark> للقيام بعملية المراجعة الداخلية الشاملة وفق الخطة السنوية المعتمدة لعام <mark><?= esc($mission['year']) ?></mark>.</p>

    <p class="body-p">عليه نأمل التكرم بتوجيه من يلزم للعمل على التنسيق خلال مدة لا تتجاوز <strong>(7) أيام عمل</strong> من تاريخ استلام هذا الإشعار.</p>
    ...
    <p class="body-p">كما نأمل التكرم بتوجيه المختصين لتزويدنا بالمتطلبات الأولية والاطلاع والموافقة على اتفاقية مستوى الخدمة من قبل ممثل الإدارة حتى يتسنى لنا البدء بعملية المراجعة.</p>
    <p class="body-p">إن تحضير هذه المتطلبات والموافقة على الاتفاقية مسبقاً سوف يساهم في سرعة وسهولة عملية المراجعة الداخلية ويقلل من إرباك أو مقاطعة موظفي الإدارة.</p>
    ...
    <?php endif; ?>
    <p class="body-p">وتقبلوا وافر التحية والتقدير،،.</p>

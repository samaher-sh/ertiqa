...
<body>
    ...
    <table class="info">
        <tr><td class="label">رقم المهمة</td><td><?= esc($mission['mission_code']) ?></td>
            <td class="label">السنة</td><td><?= esc($mission['year']) ?></td></tr>
        <tr><td class="label">عنوان المهمة</td><td colspan="3"><?= esc($mission['title']) ?></td></tr>
        <tr><td class="label">الإدارة المستهدفة</td><td colspan="3"><?= esc($targetDept['name_ar'] ?? '') ?></td></tr>
        <tr><td class="label">المراجع المسؤول</td><td><?= esc($mission['reviewer_name'] ?? '—') ?></td>
            <td class="label">مدير الإدارة</td><td><?= esc($mission['director_name'] ?? '—') ?></td></tr>
        <tr><td class="label">حالة التقرير</td><td colspan="3"><span class="badge-yes">معتمد</span></td></tr>
    </table>

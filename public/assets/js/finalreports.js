...
/* زر "تصدير PDF" (رئيس إدارة المراجعة الداخلية، تقارير معتمدة فقط) -- مستخدم
   ...
   بدل تكرارها بمكانين. يفتح مستند mPDF حقيقي (PdfController::finalReport)
   يجمع المراحل الست بصفحة مستقلة لكل مرحلة (page-break-before)، بنفس آلية
   تصدير مصفوفة المخاطر/ملخص الاجتماع بالضبط */
